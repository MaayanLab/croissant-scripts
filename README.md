...
The included scripts can be adjusted to create Croissant JSON-LD files that conform to the [Croissant specification](https://docs.mlcommons.org/croissant/docs/croissant-spec.html).
